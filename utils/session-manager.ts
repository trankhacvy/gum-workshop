...
import { GPLCORE_PROGRAMS, SessionWalletInterface } from "@gumhq/react-sdk"

export const updateSessionWallet = async (
  sessionPublicKey: PublicKey | null,
  sessionToken: string | null,
  createSession: SessionWalletInterface['createSession']
) => {
